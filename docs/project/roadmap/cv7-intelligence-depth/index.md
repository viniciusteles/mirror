...
|------|------|----------------------|--------|
| [CV7.E1](cv7-e1-observability/index.md) | Pipeline Observability & Evals | Every LLM call is logged and inspectable; behavior can be evaluated across versions, models, and prompt revisions | Planned |
| [CV7.E2](cv7-e2-reception/index.md) | Reception & Conditional Composition | A small reception step classifies each turn (persona, journey, identity-touch, shadow-touch); the system prompt loads only what reception activates | Planned |
| [CV7.E3](cv7-e3-extraction-quality/index.md) | Extraction Quality | Memory extracted from conversations is fewer, sharper, deduplicated against existing memory; descriptors for routing are generated and curated | Planned |
