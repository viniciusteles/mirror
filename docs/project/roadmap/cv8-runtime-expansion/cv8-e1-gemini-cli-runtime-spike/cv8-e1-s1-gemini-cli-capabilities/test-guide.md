...
```bash
test -f docs/project/roadmap/cv8-runtime-expansion/cv8-e5-gemini-cli-runtime-spike/cv8-e5-s1-gemini-cli-capabilities/index.md
test -f docs/project/roadmap/cv8-runtime-expansion/cv8-e5-gemini-cli-runtime-spike/cv8-e5-s1-gemini-cli-capabilities/plan.md
test -f docs/project/roadmap/cv8-runtime-expansion/cv8-e5-gemini-cli-runtime-spike/cv8-e5-s1-gemini-cli-capabilities/test-guide.md
```
...
- no Gemini CLI runtime adapter files exist yet
- no Python runtime behavior changed

---

## 3. Verify Gemini CLI installation evidence is recorded
...
Confirm `plan.md` has an initial Gemini CLI target parity level:

```text
Initial Gemini CLI target parity: L0/L1/L2/L3/L4
```
